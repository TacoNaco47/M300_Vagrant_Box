<?php
//send_email.php
$email_from = "contact@nbs-bank.com";   //Absender falls keiner angegeben wurde
$sendermail_antwort = false;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht
 
$empfaenger = "mbl@nbs-bank.com"; //Empfänger-Adresse
$mail_cc = "michael.blickenstorfer@outlook.com"; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
