...
if(sha1($code) != $user['passwortcode']) {
	error("Der übergebene Code war ungültig. Stellen Sie sicher, dass Sie den genauen Link in der URL aufgerufen haben. Sollten Sie mehrmals die Passwort-vergessen Funktion genutzt haben, so rufen Sie den Link in der neuesten E-Mail auf.");
}
